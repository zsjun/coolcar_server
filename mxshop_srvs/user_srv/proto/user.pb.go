...
var file_user_srv_proto_user_proto_rawDesc = []byte{
	...
	0x73, 0x73, 0x22, 0x30, 0x0a, 0x08, 0x50, 0x61, 0x67, 0x65, 0x49, 0x6e, 0x66, 0x6f, 0x12, 0x0e,
	...
	0x20, 0x01, 0x28, 0x04, 0x52, 0x08, 0x62, 0x69, 0x72, 0x74, 0x68, 0x44, 0x61, 0x79, 0x22, 0xba,
	...
	0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x52, 0x04, 0x64, 0x61, 0x74, 0x61, 0x32, 0xb5, 0x02, 0x0a,
...
var file_user_srv_proto_user_proto_goTypes = []interface{}{
...
func file_user_srv_proto_user_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_user_srv_proto_user_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
		...
		file_user_srv_proto_user_proto_msgTypes[1].Exporter = func(v interface{}, i int) interface{} {
		...
		file_user_srv_proto_user_proto_msgTypes[2].Exporter = func(v interface{}, i int) interface{} {
		...
		file_user_srv_proto_user_proto_msgTypes[3].Exporter = func(v interface{}, i int) interface{} {
		...
		file_user_srv_proto_user_proto_msgTypes[4].Exporter = func(v interface{}, i int) interface{} {
		...
		file_user_srv_proto_user_proto_msgTypes[5].Exporter = func(v interface{}, i int) interface{} {
		...
		file_user_srv_proto_user_proto_msgTypes[6].Exporter = func(v interface{}, i int) interface{} {
		...
		file_user_srv_proto_user_proto_msgTypes[7].Exporter = func(v interface{}, i int) interface{} {
		...
		file_user_srv_proto_user_proto_msgTypes[8].Exporter = func(v interface{}, i int) interface{} {
